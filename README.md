...
Production-grade multi-AZ AWS architecture provisioned with modular Terraform.

- Auto-scaling EC2 fleet behind ALB · Private RDS PostgreSQL · AWS Secrets Manager
- Full CI/CD: GitHub Actions → Docker build → ECR push → Terraform apply
